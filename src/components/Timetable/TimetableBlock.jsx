...
const TimetableBlock = React.memo(
    ({
        ...
        return (
            ...
            >
                <Link to={`/timetable/pages/${id}`} className="timetable-block">
                    <div className="timetable-block-top">
                        <div className="timetable-block-type">
                            {Object.keys(categories).length && (
                                <span className="timetable-block__type_color">
                            ...
                            {Object.keys(timetableType).length && (
                                <span className="timetable-block__type_gray">
                        ...
                        <h3 className="timetable-block__title">{title}</h3>
                        <div className="timetable-block-date">
                            ...
                            <span className="timetable-block__date">
                    ...
                    <div className="timetable-block-bottom">
                            ...
                            {Object.keys(auths).length ?
                                auth.map((key) => (
                                    ...
                                    >
                                        ...
                                        ></div>
                                        <span className="auth__name timetable-block-auth__name">
                                            {auths[key].name}
                                        </span>
                                    </div>
                                )) : null}
                        ...
                        <div className="timetable-block-btn">
                            <span className="btn-bold_color timetable-block__btn">
                                Записаться
                            </span>
                        </div>
                    </div>
