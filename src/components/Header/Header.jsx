                                            ...
                                            <div className="header-user">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <path
                                                                d="M20 13.5385V5.00946C20 3.65642 18.8866 2.55708 17.5163 2.55708H14.5024L14.4617 2.38795C14.1313 0.982563 12.8793 0 11.4152 0H8.58483C7.12072 0 5.86868 0.982563 5.53834 2.38795L5.49755 2.55708H2.48369C1.11338 2.55708 0 3.65642 0 5.00946V13.5385C0 14.9518 1.16639 16.1035 2.59788 16.1035H17.394C18.8336 16.1076 20 14.9559 20 13.5385ZM18.6011 13.5385C18.6011 14.1907 18.0628 14.7224 17.4021 14.7224H2.60196C1.94127 14.7224 1.40294 14.1907 1.40294 13.5385V5.00946C1.40294 4.42153 1.88825 3.9383 2.48777 3.9383H6.05628C6.38254 3.9383 6.66395 3.71682 6.73736 3.40273L6.90457 2.70205C7.08809 1.92486 7.7814 1.38123 8.58891 1.38123H11.4193C12.2268 1.38123 12.9201 1.92486 13.1036 2.70205L13.2708 3.40273C13.3442 3.71682 13.6256 3.9383 13.9519 3.9383H17.5204C18.1158 3.9383 18.6052 4.41751 18.6052 5.00946V13.5385H18.6011Z"
                                                                fill={color}
                                                            />
                                                            <path
                                                                d="M10 5.08594C7.61827 5.08594 5.677 6.99871 5.677 9.35445C5.677 11.7061 7.6142 13.623 10 13.623C12.3817 13.623 14.323 11.7102 14.323 9.35445C14.3189 7.00274 12.3817 5.08594 10 5.08594ZM10 12.2377C8.38907 12.2377 7.07586 10.9451 7.07586 9.35042C7.07586 7.75979 8.385 6.46314 10 6.46314C11.6109 6.46314 12.9241 7.75576 12.9241 9.35042C12.9201 10.9451 11.6109 12.2377 10 12.2377Z"
                                                                fill={color}
                                                            />
                                                            <path
                                                                d="M3.31976 5.08594H3.29529C2.90785 5.08594 2.5979 5.39601 2.5979 5.77857C2.5979 6.16112 2.91193 6.46716 3.29529 6.46716H3.31976C3.7072 6.46716 4.02123 6.15709 4.02123 5.77857C4.01715 5.39601 3.70312 5.08594 3.31976 5.08594Z"
                                                                fill={color}
                                                            />
                                                        </svg>
                                                        Сессионная комната
