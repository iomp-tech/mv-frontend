    ...
    return (
        <>
            <div style={{position: "relative"}}>
                ...
                ></span>
                <label
                    className={`cabinet-input__label`}
                ...
                {typeConst === "password" ? (
                    <div
                        ...
                        className="input-eye cabinet-input-eye"
                    >
            ...
            <div>
                {touched && error && (
                    <span className={`cabinet-input__label__error`}>
                        {error}
                    </span>
                )}
            </div>
...
export default CabinetInputRender;
